...
import 'package:jitak/model/getx_controller.dart';
import 'package:jitak/view/tab/edit_store_profile_tablet.dart';
import 'package:jitak/view/tab/stamp_card_details_tablet.dart';
import 'package:jitak/viewModel/home.dart';
import 'package:jitak/viewModel/text.dart';
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      child: Obx(
                                        () => InkWell(
                                          onTap: () {
                                            controller.likedStatuses[index]
                                                    .value =
                                                !controller
