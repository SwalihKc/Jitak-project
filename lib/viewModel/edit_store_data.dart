...
List<AssetImage> firstrow = [
  const AssetImage("assets/home_image.png"),
  const AssetImage("assets/home_image.png"),
  const AssetImage("assets/Home_image(3).png"),
];
List<AssetImage> secondrow = [
  const AssetImage("assets/resturant_image.png"),
  const AssetImage("assets/resturant_image.png"),
  const AssetImage("assets/resturant_image.png"),
];
List<AssetImage> thirdrow = [
  const AssetImage("assets/food(1).png"),
  const AssetImage("assets/food(2).png"),
  const AssetImage("assets/food(3).png"),
];
List<AssetImage> fourthrow = [
 const AssetImage("assets/4th row(1).png"),
  const AssetImage("assets/4th row(2).png"),
  const AssetImage("assets/4th row(3).png"),
];
List<AssetImage> fifthrow = [
  const AssetImage("assets/4th row(1).png"),
  const AssetImage("assets/drink.png"),
  const AssetImage("assets/iceCream.png"),
];
